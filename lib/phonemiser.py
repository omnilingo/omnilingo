"""Functions for doing grapheme to phoneme for supported languages The default.

functions first do LRLM segmentation of the orthography and then lookup
the. segments in a lookup table. Any symbols which do not appear are
discarded.
"""
