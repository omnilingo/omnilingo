...
if __name__ == "__main__":
	(n_total, n_lines, n_skipped, n_voc) = index(sys.argv[1], 'cache/' + sys.argv[1].split('/')[-1])

	print(n_lines,'/',n_total,'indexed,', n_skipped, 'skipped. Vocabulary size:', n_voc, file=sys.stderr)
